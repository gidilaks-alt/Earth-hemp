...
/**
 * Scanned Desert Edition bag (Higgsfield SAM-3D from the real product photo).
 * Source GLB has arbitrary scale/origin, so it's re-centered and normalized
 * to roughly a 2-unit bounding box to match the hero camera framing.
 */
